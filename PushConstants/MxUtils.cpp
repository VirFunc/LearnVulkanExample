...
namespace Mix
{
	...
	void MxTransform::translate(const glm::vec3 & translation, const MxTransform & relativeTo)
	{
		mPosition = mPosition +
	...
	void MxTransform::translate(const float x, const float y, const float z, const MxTransform & relativeTo)
	{
		translate(glm::vec3(x, y, z), relativeTo);
	}
