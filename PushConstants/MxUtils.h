...
namespace Mix
{
	...
	public:
		...
		void translate(const glm::vec3& translation, const MxTransform& relativeTo);
		void translate(const float x, const float y, const float z, const MxTransform& relativeTo);
