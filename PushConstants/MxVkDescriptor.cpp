...
namespace Mix {
    namespace Vk {
        ...
        std::vector<VkDescriptorSet> MxVkDescriptorPool::allocDescriptorSet(const std::vector<DescriptorSetLayout>& layouts) {
        ...
        VkDescriptorSet MxVkDescriptorPool::allocDescriptorSet(const DescriptorSetLayout & layout) {
            return allocDescriptorSet(layout.getDescriptorSetLayout());
        }

        std::vector<VkDescriptorSet> MxVkDescriptorPool::allocDescriptorSet(const DescriptorSetLayout & layout, const uint32_t count) {
        ...
        DescriptorSetLayout::DescriptorSetLayout() :mLayout(VK_NULL_HANDLE) {
        }


        void DescriptorSetLayout::addBindings(uint32_t binding, VkDescriptorType type, uint32_t count, VkShaderStageFlags stage, const VkSampler * immutableSamplers) {
        ...
        bool DescriptorSetLayout::createDescriptorSetLayout() {
